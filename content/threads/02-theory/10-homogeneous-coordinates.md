...
فقط یک مقدار کمکیه که به ما اجازه می‌ده Transformation هایی که قبلاً نمی‌تونستیم با Matrix انجام بدیم، حالا وارد همین سیستم بشن.
...
حالا می‌تونه به شکل نمایش داده بشه:
...
اما حالا می‌تونیم اون رو هم به شکل یک **Transformation Matrix** نمایش بدیم.
...
و این یعنی حالا می‌تونیم همه‌ی اون‌ها رو با هم **ترکیب** کنیم.
